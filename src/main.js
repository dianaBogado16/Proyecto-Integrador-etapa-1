...
const start3 = () => {
    ...
    const fragmento = new DocumentFragment(); /* Elemento que esta en memoria */
    ...
    productos.forEach(prod => {
        ...
        articulo.appendChild(cardContent)
        console.log(card)
        /* se interviene 5 veces creandose cada card */
    ...
    // Intervengo una sola vez el DOM y cargo de una los 5 elementos
